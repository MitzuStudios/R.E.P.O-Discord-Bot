  ...
  async execute(interaction) {
    ...
    try {
      const dmEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `Has sido baneado del servidor **${interaction.guild.name}**.`
        )
        .addFields(
      ...
      if (evidence) {
        ...
        dmEmbed.addFields({
          name: "Evidencia",
          value: `[Ver evidencia](${evidence.url})`,
        });
      }

      dmEmbed.addFields({
        name: "Si deseas apelar el ban, puedes hacerlo en el siguiente enlace:",
        value: "[Apelar]()",
      });
      ...
      console.error(
        `No se pudo enviar un mensaje privado a ${user.tag}:`,
        error
      );
    }
    ...
    try {
      ...
      const banEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `El usuario **${user.tag}** ha sido baneado correctamente.`
        )
        .addFields(
          { name: "Razón", value: reason },
          { name: "Moderador", value: interaction.user.tag }
